...
const QuizPage = () => {
  ...
  const questions = [
    ...
    {
      id: 11,
      question: "Upload your couple photo 📸",
      isImageUpload: true,
    },
    {
      id: 12,
      question: "What do you feel when you see this photo?",
      options: [
        { text: "😍 In love", value: 1 },
        { text: "😊 Happy", value: 0 },
        { text: "😢 Emotional", value: 0 },
        { text: "🍀 Lucky", value: 0 },
      ],
    },
    {
    ...
    {
      id: 14,
      question: "What was special that day?",
      options: [
        { text: "💍 Proposal", value: 1 },
        { text: "💕 First date", value: 0 },
        { text: "🎂 Birthday", value: 0 },
        { text: "🎁 Surprise", value: 0 },
      ],
    },
    {
      id: 15,
      question: "Who clicked this photo?",
      options: [
        { text: "🤳 Selfie", value: 1 },
        { text: "🙋 Me", value: 0 },
        { text: "🙋‍♀️ She", value: 0 },
    ...
    },
    {
      ...
      options: [
        ...
        { text: "☀️ Afternoon", value: 0 },
        { text: "🌆 Evening", value: 0 },
      ],
    },
    {
      id: 18,
      question: "What memory is attached to this photo?",
      options: [
    ...
    {
      id: 19,
      question: "Would you frame this photo?",
      options: [
        { text: "💯 Definitely", value: 1 },
        { text: "✅ Yes", value: 0 },
        { text: "👍 Of course", value: 0 },
        { text: "🤔 Maybe", value: 0 },
      ],
    },
    {
      id: 20,
      question: "Will you share this photo with her?",
      options: [
        { text: "🎁 Surprise her", value: 1 },
        { text: "✅ Yes", value: 0 },
        { text: "📤 Already shared", value: 0 },
        { text: "🤫 Keep secret", value: 0 },
      ],
    },
    {
      id: 21,
